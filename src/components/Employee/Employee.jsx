    ...
    <>
      ...
      <form>
        <div className="input-container">
          ...
          <input type="text" name="employee-name" placeholder="Entrez le nom de l'employé"/>
        </div>
        
        <div className="input-container">
          <label htmlFor="employee-forname">Prénom</label>
          <input type="text" name="employee-forname" placeholder="Entrez le prénom de l'employé"/>
        </div>   
